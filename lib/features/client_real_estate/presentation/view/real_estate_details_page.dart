...
import 'package:real_estate/features/client_real_estate/presentation/view/widgets/real_estates/auto_image_carousel.dart';
...
class RealEstateDetailsPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    var addressTag =
        clientRealEstateAddressesController.properties.firstWhereOrNull(
          (e) => e["id"].toString() == property['address_tag'],
        )?["name"] ??
        "";
    return Scaffold(
    ...
    return Wrap(
      ...
      children: [
        _buildInfoCard(
          ...
          'العرض',
          '${offerTypesController.properties.firstWhereOrNull((element) => element['id'].toString() == property['offer_type'])?['name'] ?? '-'}',
        ),
        _buildInfoCard(
          Icons.apartment_outlined,
          'النوع',
          '${clientRealEstateTypesController.properties.firstWhereOrNull((element) => element['id'].toString() == property['type'])?['name'] ?? '-'}',
        ),
        _buildInfoCard(
        ...
        _buildInfoCard(
          ...
          'الإكساء',
          '${realEstateCladingTypesController.properties.firstWhereOrNull((element) => element['id'].toString() == property['clading'])?['name'] ?? '-'}',
        ),
